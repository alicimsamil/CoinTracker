package com.alicimsamil.cointracker.feature.listing.presentation.custom
...
class LineChartView @JvmOverloads constructor(
    ...
    fun setLineColor(color: LineColor){
        lineColor = if (color == LineColor.RED){
            Color.RED
        } else {
            Color.GREEN
        }
    ...
    companion object {
        private const val CHART_PADDING = 7
        private const val LINE_STROKE_WIDTH = 3
    }
